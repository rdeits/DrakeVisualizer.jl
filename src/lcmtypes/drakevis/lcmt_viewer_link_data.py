...
import drakevis.lcmt_viewer_geometry_data
...
class lcmt_viewer_link_data(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_geom):
            assert self.geom[i0]._get_packed_fingerprint() == drakevis.lcmt_viewer_geometry_data._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.geom = []
        for i0 in range(self.num_geom):
            self.geom.append(drakevis.lcmt_viewer_geometry_data._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x4b645ec7a5743a2a+ drakevis.lcmt_viewer_geometry_data._get_hash_recursive(newparents)) & 0xffffffffffffffff
